...
int main() {
    ...
    assert((pow(x, 2)) == "+123456790123456790123456790123454320987654320987654320987654321"s);

    assert(((0 - x)) == "-11111111111111111111111111111111"s);

    assert(((0 - x).abs()) == "+11111111111111111111111111111111"s);
